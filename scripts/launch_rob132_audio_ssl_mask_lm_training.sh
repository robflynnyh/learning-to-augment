...
export CONFIG_PATH CHECKPOINT_PATH QUEUED_COMMAND GIT_BRANCH GIT_COMMIT
...
echo "[rob132] ssl_feature_mode=on_the_fly"
...
if [ "${ROB132_SMOKE:-0}" = "1" ]; then
  echo "[rob132] running smoke on-the-fly SSL training path"
