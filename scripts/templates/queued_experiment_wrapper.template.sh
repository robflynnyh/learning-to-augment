#!/usr/bin/env bash
# Template for Learn-to-Augment long-running GPU experiments launched through with-gpu.
...
LOG_PATH="${LOG_PATH:-results/example/logs/run.log}"
RESULTS_PATH="${RESULTS_PATH:-results/example}"
SCREEN_NAME="${SCREEN_NAME:-l2a_example_run}"
