...
RESULT_ROOT="${RESULT_ROOT:-${REPO_DIR}/exp/results/repro/reward_conditioned_lm/no_audio_conditioning/rob124_384_dropout_rmm_lm_rerank}"
...
PREVIOUS_ROB124_CSV="${PREVIOUS_ROB124_CSV:-${REPO_DIR}/exp/results/repro/reward_conditioned_lm/no_audio_conditioning/rob124_384_dropout_earnings_reward_controls/rob124_384_dropout_earnings_reward_controls.csv}"
ROB120_CSV="${ROB120_CSV:-${REPO_DIR}/exp/results/repro/reward_conditioned_lm/no_audio_conditioning/rob120_earnings_reward_controls/rob120_earnings_reward_controls.csv}"
