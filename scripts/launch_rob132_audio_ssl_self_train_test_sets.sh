...
LOG_PATH="${LOG_PATH:-${RESULT_ROOT}/logs/rob132_audio_ssl_test_fixed_rewards.log}"
SCREEN_LOG_PATH="${SCREEN_LOG_PATH:-${RESULT_ROOT}/logs/rob132_audio_ssl_test_fixed_rewards.screen.log}"
