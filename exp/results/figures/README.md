...
python3 exp/results/scripts/plot_ufmr_mask_distribution.py \
  ...
  --repeats 15 \
  --num-samples 100000 \
  --output exp/results/figures/UFMR_mask_n100000.pdf \
  --csv exp/results/figures/UFMR_mask_n100000.csv
```
...
python3 exp/results/scripts/plot_ufmr_mask_distribution.py \
  ...
  --repeats 15 \
  --num-samples 100000 \
  --output exp/results/figures/UFMR_mask_mseloss_n100000.pdf \
  --csv exp/results/figures/UFMR_mask_mseloss_n100000.csv
```
...
python3 exp/results/scripts/plot_ufmr_mask_distribution.py \
  ...
  --repeats 15 \
  --num-samples 100000 \
  --output exp/results/figures/UFMR_mask_mseloss2e1_n100000.pdf \
  --csv exp/results/figures/UFMR_mask_mseloss2e1_n100000.csv
```
...
python3 exp/results/scripts/plot_ufmr_mask_distribution.py \
  --mode random \
  --num-samples 100000 \
  --output exp/results/figures/RFM_mask_n100000.pdf \
  --csv exp/results/figures/RFM_mask_n100000.csv
```
...
python3 exp/results/scripts/plot_mask_distribution_comparison.py \
  --series UFMR exp/results/figures/UFMR_mask_mseloss_n100000.csv \
  --series 'Random FM' exp/results/figures/RFM_mask_n100000.csv \
  --output exp/results/figures/mask_distribution_random_vs_mseloss.pdf
```
