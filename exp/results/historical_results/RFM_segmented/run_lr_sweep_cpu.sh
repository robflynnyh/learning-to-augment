...
configs=(
  exp/results/historical_results/RFM_segmented/tedlium_lr1e-5.yaml
  exp/results/historical_results/RFM_segmented/tedlium_lr5e-5.yaml
  exp/results/historical_results/RFM_segmented/tedlium_lr9e-5.yaml
)
