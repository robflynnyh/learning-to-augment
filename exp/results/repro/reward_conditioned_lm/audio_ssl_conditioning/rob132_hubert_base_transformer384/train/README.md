...
Artifact:
`exp/results/repro/reward_conditioned_lm/audio_ssl_conditioning/rob132_hubert_base_transformer384/train/mapping_verification_sample.json`
...
Artifact:
`exp/results/repro/reward_conditioned_lm/audio_ssl_conditioning/rob132_hubert_base_transformer384/train/smoke/post_training_generation_sanity_on_the_fly.json`
...
Artifact:
`exp/results/repro/reward_conditioned_lm/audio_ssl_conditioning/rob132_hubert_base_transformer384/train/smoke/post_training_generation_sanity_native_gpu.json`
...
```text
exp/results/repro/reward_conditioned_lm/audio_ssl_conditioning/rob132_hubert_base_transformer384/train/logs/rob132_microbatch_gpu_prefix_20260525.log
```
