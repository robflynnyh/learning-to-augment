...
This result root tracks the 2026-05-25 follow-up requested after the completed
ROB-124 `[0.5, 1.0]` all-dataset sweep.
...
- Reward control: sample `conditioning_reward` uniformly from `[0.0, 1.0]`
