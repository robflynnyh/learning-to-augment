...
python3 -m json.tool exp/results/repro/reward_conditioned_lm/no_audio_conditioning/rob124_384_dropout_rmm_lm_rerank/preflight_cropped_earnings_rollout.json >/dev/null
git diff --check
```
...
```text
exp/results/repro/reward_conditioned_lm/no_audio_conditioning/rob124_384_dropout_rmm_lm_rerank/preflight_cropped_earnings_rollout.json
```
