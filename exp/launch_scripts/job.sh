...
python generate.py --config ./configs/configs_in_paper/CM_train/CM.yaml --index $SLURM_ARRAY_TASK_ID --steps 5 --repeats 18 --skip_percentage 98.0 --remove_skipped_paths
