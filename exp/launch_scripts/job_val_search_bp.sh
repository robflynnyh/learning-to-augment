...
python generate_search.py --config ./configs/configs_in_paper/conditional_multistep_mask_lm/generation_rp.yaml --split 'dev' --index $SLURM_ARRAY_TASK_ID --steps 1 
...
# fi
#learning-to-augment/exp/configs/configs_in_paper/multistep_FM_ranker
